...
class CategorieController extends Category{


    public function index(){
        $Categorys = $this->getCategoryData();
        View::render('back/Admin/Categories.twig',['Categorys' => $Categorys]);
    }
    ...
    public function deleteCategory() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($id) {
                $result = $this->deleteCategorys($id); // Make sure deleteCategorys() is implemented in the Category model
